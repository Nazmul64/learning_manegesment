...
@section('userdashboard')
  ...
  <div class="media media-card align-items-center">
        <div class="media-img media--img media-img-md rounded-full">
            <img class="rounded-full" src="{{ (!empty($profileData->photo))  ? url('upload/admin_images/'.$profileData->photo)  : url('upload/avator.jpg')}}" alt="Student thumbnail image">
        </div>
        <div class="media-body">
             <h2 class="section__title fs-30 text-success">Hello,{{ $profileData->name }}</h2>
        </div><!-- end media-body -->
 </div><!-- end media -->
                    ...
                    <form method="post" action="{{ route('user.profile.update') }}" class="row pt-40px">
                        ...
                        <div class="media media-card align-items-center">
                            <div class="media-img media-img-lg mr-4 bg-gray">
                                <img class="mr-3" src="{{ (!empty($profileData->photo))  ? url('upload/admin_images/'.$profileData->photo)  : url('upload/avator.jpg')}}" alt="avatar image">
                            </div>
                            <div class="media-body">
