                         ...
                         @csrf
                          ...
                          <div class="input-box">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control" type="text" id="name" name="name" placeholder="Last name">
                            ...
                            <div class="input-box">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control" type="email" id="email" name="email" placeholder="Last name">
                                    <span class="la la-user input-icon"></span>
                                </div>
                            </div><!-- end input-box -->
                            <div class="input-box">
                             ...
                             <div class="input-box">
                                <label class="label-text">Confirmation Password</label>
                                <div class="form-group">
                                    <input class="form-control form--control" type="password" id="password_confirmation" name="password_confirmation" id="password_confirmation" placeholder="Last name">
                                    <span class="la la-user input-icon"></span>
                                </div>
                            </div><!-- end input-box -->
                            <div class="btn-box">
